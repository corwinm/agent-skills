...
7. Clearly label uncertainty and omissions caused by budget, missing evidence, consent restrictions, or provenance gaps. Preserve every included evidence record's type and limitations; every interpretation's author and material alternatives; every assumption's owner, consequence if wrong, risk, and proposed validation; and every decision's chosen action, alternatives considered, rationale, evidence used, unresolved dissent, owner, and date. Use `Unknown` for unavailable values.
