...
button { font: inherit; }
.review-trigger { display: inline-flex; min-width: 44px; min-height: 44px; align-items: center; justify-content: center; gap: 8px; border: 1px solid var(--line); border-radius: 9px; background: var(--surface); color: var(--accent); cursor: pointer; padding: 10px; box-shadow: 0 1px 2px #18181b0a; transition: border-color .15s ease, background .15s ease, box-shadow .15s ease, transform .15s ease; }
.review-trigger:hover { border-color: #a1a1aa; background: var(--accent-soft); box-shadow: 0 3px 10px #18181b12; }
.review-trigger:active { box-shadow: none; }
...
.page-comment { float: right; min-height: 44px; margin: 0 0 16px 16px; padding-inline: 14px; font-weight: 700; } #review-drawer { position: fixed; left: 50%; top: 50%; width: min(560px, calc(100vw - 32px)); margin: 0; transform: translate(-50%, -50%); max-height: min(720px, calc(100vh - 32px)); border: 1px solid var(--line); border-radius: 14px; padding: 28px; box-shadow: 0 24px 80px #18181b30; }
