...
Requires Node.js 24 or newer. The independently installable `discovery-workspace` skill bundles its workspace CLI, renderer, and complete review server runtime. From the installed skill directory, run:
